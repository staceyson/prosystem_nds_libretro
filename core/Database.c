...
// Rocket - the external database file likely is not useful in a libretro core situation.  It will be
//          left out for now.  Better to implement core options to be used in game overrides as needed?
#if 0
