...
#if 0
/* Rocketfan - BG_PALLET comes from LIbnds and is actually the location of the pallet 
   on the NDS in memory?  Not much use to libretro.  Instead, in Libretro.c the 
   game load inits some LUTs used by the BLITing macro from the pallet_data array. */
